...
operator_list = [820646247, ]  # Виолетта оператор
...
# main_chat_id = -905852339
main_chat_id = -1001244442466
...
start_not_in_db = "Привет, друг\! Я Тимур, бот для онбординга @onboardingtfbot, " \
                  "помогу тебе быстро адаптироваться в **[ТИМ ФОРС](https://teamforce.ru)** \. " \
                  "У меня ты можешь узнать много полезной информации😇\n\n" \
                  "К сожалению, я не нашел тебя в своей базе\. Пожалуйста, обратись к \@abuzinaa\n" \
...
expense_center_xlsx_dict = {
    "1": "/Блок Проекты",
    "2": "/Блок Проекты/Группа договорной работы",
    "3": "/Блок Проекты/Группа координаторов",
    "4": "/Блок Проекты/Тендерная группа",
    "5": "/Блок Развитие",
    "6": "/Блок Ресурсы",
    "7": "/Блок Ресурсы/Отдел КДП",
    "8": "/Блок Ресурсы/Отдел рекрутмента",
    "9": "/Блок Ресурсы/Группа ресурсного менджмента",
    "10": "/Блок Сервисы",
    "11": "/Блок Технологии",
    "12": "/Блок Финансы/Бухгалтерия",
    "13": "/Блок Финансы/Казначейство"
}

business_role_xlsx_dict = {
    "1": "Основатель",
    "2": "Операционный директор",
    "3": "Директор программы",
    "4": "Директор блока",
    "5": "Лидер группы",
    "6": "Руководитель проектов",
    "7": "Аккаунт-менеджер",
    "8": "Специалист по договорной работе",
    "9": "Тендерный специалист",
    "10": "Координатор проектов",
    "11": "Партнерский менеджер",
    "12": "Специалист КДП",
    "13": "Рекрутер",
    "14": "Ресурсный менеджер",
    "15": "Менеджер",
    "16": "Руководитель ИТ-службы",
    "17": "Юрист",
    "18": "Менеджер продукта",
    "19": "Разработчик B2BCloud",
    "20": "Бухгалтер по основной деятельности",
    "21": "Бухгалтер",
    "22": "Бухгалтер по вспомогательной деятельности",
    "23": "Бухгалтер по расчету заработной платы",
    "24": "Главный бухгалтер",
    "25": "Бухгалтер-операционист",
    "26": "Финансовый менджер",
    "27": "Стажер",
    "28": "Разработчик PHP",
    "29": "Разработчик JS",
    "30": "Тестировщик",
    "31": "Python разработчик",
    "32": "Ассистент отдела развития",
}
