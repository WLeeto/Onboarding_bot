...
newbie_greeting = "Потрясающе, в команде пополнение!" \
                  "Я бот ХХХХ Помогу тебе быстро адаптироваться в ТИМ ФОРС. " \
                  "Удели мне 7 минут За это время: - сформируем твою карточку специалиста -сориентирую, " \
                  "куда по каким вопросам обращаться -покажу волшебные кнопки, " \
                  "где храним важноеСамое время познакомиться. "
