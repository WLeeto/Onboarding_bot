...
button_7 = InlineKeyboardButton(text="Поиск по тегу", callback_data="search by_tag")
search_way.add(button_1, button_2, button_3, button_4, button_5, button_6, button_7)
